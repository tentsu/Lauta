...
var Thread = React.createClass({displayName: 'Thread',
    ...
    render: function() {
        ...
        var answers = this.props.data.answers.map(function(answer, index) {
            return (
                React.createElement(Answer, {data: answer})
            );
        });
//        console.log(this.props)
        return (
...
//        this.props = this.props.data;
        ...
        var postStyles = (this.props.data.op) ? cx({
            'post': true,
            'op': true,
            'answer': false
        }) : cx({
        ...
        var titleBar = (this.props.data.op)
            ?   React.createElement("div", {className: "title"}, 
                    React.createElement("a", {href: this.props.data.id}, "DMASFMKSAFJKASJFKAJF")
                )
            : "";
