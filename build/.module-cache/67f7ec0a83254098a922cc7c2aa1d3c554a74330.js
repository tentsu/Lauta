...
.factory("ThreadResource", ThreadResource)
.factory('ThreadFactory', ThreadFactory)
.controller('ThreadCtrl', ThreadCtrl);

function ThreadResource($resource, $http) {
    return $resource("/getposts",
        {id: "@id"},
        {"query": {
            method: "GET",
            isArray: true,
...
function ThreadFactory($http, $q, ThreadResource) {
    function getThreads() {
        console.log("Loading messages...");
        
//        var d = $q.defer();
//        ThreadResource.query({id:122}, function(data) {
//            d.resolve(temp);
//        });
//           
//        return d.promise;
